...
# Auto-submit iOS Build 6 to App Store when ready
# Build ID: e88514a2-420c-407b-9b6f-1d81792c06f8

BUILD_ID="e88514a2-420c-407b-9b6f-1d81792c06f8"
GREEN='\033[0;32m'
RED='\033[0;31m'
YELLOW='\033[1;33m'
NC='\033[0m' # No Color
...
echo "=========================================="
echo "🍎 iOS Build 6 Monitor & Auto-Submit"
echo "=========================================="
echo ""
echo "Build ID: $BUILD_ID"
echo "Changes: Google Sign-In OAuth fix"
...
while [ $ATTEMPT -lt $MAX_ATTEMPTS ]; do
    ...
    if [[ "$STATUS" == *"finished"* ]] || [[ "$STATUS" == *"Finished"* ]]; then
        ...
        if [ $? -eq 0 ]; then
            ...
            echo "4. Add testers or submit for App Review"
        else
        ...
        echo ""
        echo "To retry:"
        echo "eas build --platform ios --profile production --non-interactive --no-wait"
        exit 1
    else
